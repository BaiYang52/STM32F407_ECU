...
C_SRCS += \
../Core/Src/bsw/timer/app_task_scheduler.c 

OBJS += \
./Core/Src/bsw/timer/app_task_scheduler.o 

C_DEPS += \
./Core/Src/bsw/timer/app_task_scheduler.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/bsw/timer/%.o Core/Src/bsw/timer/%.su Core/Src/bsw/timer/%.cyclo: ../Core/Src/bsw/timer/%.c Core/Src/bsw/timer/subdir.mk
...
clean: clean-Core-2f-Src-2f-bsw-2f-timer

clean-Core-2f-Src-2f-bsw-2f-timer:
	-$(RM) ./Core/Src/bsw/timer/app_task_scheduler.cyclo ./Core/Src/bsw/timer/app_task_scheduler.d ./Core/Src/bsw/timer/app_task_scheduler.o ./Core/Src/bsw/timer/app_task_scheduler.su

.PHONY: clean-Core-2f-Src-2f-bsw-2f-timer
