...
Core/Src/mcal/can/%.o Core/Src/mcal/can/%.su Core/Src/mcal/can/%.cyclo: ../Core/Src/mcal/can/%.c Core/Src/mcal/can/subdir.mk
...
clean: clean-Core-2f-Src-2f-mcal-2f-can

clean-Core-2f-Src-2f-mcal-2f-can:
	-$(RM) ./Core/Src/mcal/can/can_driver.cyclo ./Core/Src/mcal/can/can_driver.d ./Core/Src/mcal/can/can_driver.o ./Core/Src/mcal/can/can_driver.su ./Core/Src/mcal/can/can_interrupt.cyclo ./Core/Src/mcal/can/can_interrupt.d ./Core/Src/mcal/can/can_interrupt.o ./Core/Src/mcal/can/can_interrupt.su ./Core/Src/mcal/can/can_lowlevel.cyclo ./Core/Src/mcal/can/can_lowlevel.d ./Core/Src/mcal/can/can_lowlevel.o ./Core/Src/mcal/can/can_lowlevel.su

.PHONY: clean-Core-2f-Src-2f-mcal-2f-can
