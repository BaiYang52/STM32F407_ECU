...
typedef enum
{
    DIM_KEY_NOT_PRESSED = 0U,   /**< 未按下 */
    DIM_KEY_PRESSED     = 1U,   /**< 按下 */
    DIM_KEY_INVALID     = 2U    /**< 无效 (卡滞/长按超过 30s) */
} DIM_KeyStateType;

/** IGN 丢失事件原因 */
typedef enum
{
    DIM_IGN_NO_EVENT       = 0U,  /**< 无事件 */
    DIM_IGN_LOST_VEH_SPEED = 1U,  /**< 车速丢失 */
    DIM_IGN_LOST_FRAME     = 2U   /**< 报文丢失 */
} DIM_IgnEventType;

/* ==================== DIM 公开变量声明 ==================== */

/** 按键 1 状态 */
extern DIM_KeyStateType g_DIM_Key1State;

/** 按键 2 状态 */
extern DIM_KeyStateType g_DIM_Key2State;

/** IGN 状态 (来自 0x210 RX) */
extern uint8 g_DIM_IGNStatus;

/** 触发 DIM 程序前置条件: 车速<5km/h */
extern boolean g_DIM_VehPrecondition;
